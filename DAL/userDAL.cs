    ...
    class userDAL
    {
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                ...
                //If the query is executed Successfully then the value to row will be greater than 0 else it will be less than 0
                if (rows>0)
                {
                    //Query Successfull
                    isSuccess = true;
